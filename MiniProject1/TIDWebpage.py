...
# ---------------------------HTML--------------------------------------
    #This part creates and opens a webpage to display results

import webbrowser, os.path    #used to open webpage
...
<html>
    ...
    <body>
        <video width="640" height="300" align="middle" controls>
...
outDescriptions = TwitterDownload(twitterHandler='BarstoolSports')
browseLocal(pageTemplate.format(outDescriptions))