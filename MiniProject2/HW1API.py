...
def get_tweets2vid(screen_name, number_tweets, rate):
    ...
    if len(validuser) == 0:
        print
        "This user does not exist or has no tweets."
        return None
    ...
    try:
        ...
        print
        "Could not create video for ffmpeg issues"
        pass
    else:
        print
        ""
