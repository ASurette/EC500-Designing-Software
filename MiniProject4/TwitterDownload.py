...
def TwitterDownload(twitterHandler):
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "PATH TO JSON HERE" #sets up the GOOGLE_APPLICATION_CREDENTIALS as an enviornment variable
    ...
    return [imageLabels, picTweets] #return the labels of all the functions as the final output
    #end of function

#calling the function
#output = TwitterDownload(twitterHandler='Osama_amasO')
#print(output)
